...
def main_menu():
	...
	p1_field_instructions = smallfont.render('Enter player 1 name below:' , True , white)
	p2_field_instructions = smallfont.render('Enter player 2 name below:' , True , white)
	p1_name = ''
	p2_name = ''
	...
	while True: 
		...
		screen.blit(p1_field_instructions, (p1_name_instructions.x+5, p1_name_instructions.y+5))
		screen.blit(p2_field_instructions, (p2_name_instructions.x+5, p2_name_instructions.y+5))
